...
feeding <- read_csv("Feeding Trial Data.csv", na = c("NA", "N/A", "")
)

# load in injection for later merging of uninjected control
injection <- read_csv("Injection Trial Data.csv",
  na = c("NA", "N/A", "")
)
...
feeding <- read_csv(
  "~/Library/CloudStorage/GoogleDrive-eterris@wisc.edu/Shared drives/Neuropeptide Project/Neuropeptide Phenotypic Trial 1 (GPA2/GPA2_LGR1 - Feeding Trial.csv",
  na = c("NA","N/A","")
) %>%
  rename(Assay_Day = `Assay Day`, CPB_Group = `CPB Group`) %>%
  mutate(
...
injection <- read_csv(
  "~/Library/CloudStorage/GoogleDrive-eterris@wisc.edu/Shared drives/Neuropeptide Project/Neuropeptide Phenotypic Trial 1 (GPA2/GPA2_LGR1 - Injection Trial (1).csv",
  na = c("NA","N/A","")
) %>%
  rename(Assay_Day = `Assay Day`, CPB_Group = `CPB Group`)
