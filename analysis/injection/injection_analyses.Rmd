...
# load and clean raw injection data
transformed_inj <- readr::read_csv(
  here("data", "inputs", "injection_trial_data.csv")
) %>%
...
readr::write_csv(
  inj_beetle_prog,
  here("results", "injection", "inj_data_transformed.csv")
)
...
readr::write_csv(
  inj_transitions_grouped,
  here("results", "injection", "inj_data_start_stop.csv")
)
```
